...
\def\greenMotif{8/1, 3/6, 4/2, 7/8}     % a2--a5 -> b5
\def\brownMotif{8/3, 3/8, 4/4, 5/2}     % a2--a5 -> b1
...
% Recurrent link between the two sides of the same neuron.
\foreach \i in {1,...,\Nneurons} {%
   \ifnum\i>\Nmotif\relax
     \draw[densely dotted, blue!60!black!25] (a\i) -- (b\i);
   \else
     \draw[densely dotted, green!50!black] (a\i) -- (b\i);
   \fi
}
