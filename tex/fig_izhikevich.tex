...
\def\xLeftPanelLabel{-0.15}
  ...
  \def\spikeFoot{0.15}
  \def\spikeTop{0.75}
  \def\spikeXOne{0.90} \def\oyFootOne{\spikeFoot} \def\oyTopOne{\spikeTop}
  \def\spikeXTwo{2.95} \def\oyFootTwo{\spikeFoot} \def\oyTopTwo{\spikeTop}
  \def\spikeXThree{4.85} \def\oyFootThree{\spikeFoot} \def\oyTopThree{\spikeTop}
  \def\spikeXFour{7.95} \def\oyFootFour{\spikeFoot} \def\oyTopFour{\spikeTop}
