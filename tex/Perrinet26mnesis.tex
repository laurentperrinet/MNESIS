...
% Left panel
\node[anchor=south west, font=\itshape\Large] at (-0.15,4.55) {pre};
\node[anchor=south west, font=\itshape\Large] at (4.15,4.55) {post};
...
\draw[greenlink] (a5) -- node[midway, sloped, above, fill=white, inner sep=1pt, font=\small] {8 ms} (b5);
