...
\begin{figure}[!t] 
  \centering
  \includegraphics[width=0.45\linewidth]{scan_num_delay.pdf}\hfill
  \includegraphics[width=0.45\linewidth]{scan_N_time.pdf}\hfill
  % \includegraphics[width=0.325\linewidth]{scan_p_A.pdf}
  \caption{%
