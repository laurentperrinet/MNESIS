...
\begin{figure}%[t]
  ...
  \caption{%
    ...
    %
    \emph{Step~2 --- second prediction (dark-red dashed box):} the green spike of $a_5$ re-enters the network as a new input. Together with the spikes now visible in the shifted context window (dark-red dashed box), spikes are routed through the dark-red delays in order to converge synchronously on $b_1$, generating a new output spike.
    %
